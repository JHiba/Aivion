...
def remove_bg_batch(
    ...
    input_files = input_files[:4]  # keep it small and friendly
...
def generate_glb_trellis(
    ...
    # -------- MULTI-IMAGE MODE --------
        ...
        for f in multi_images[:7]:  # cap at 4 views
...
# =========================
#  UI Layout (no css arg)
# =========================
with gr.Blocks() as demo:
    gr.Markdown("# AIVION")
    gr.Markdown(
        "Tabs: **Background Removal**, **Enhancements**, **Model Comparison**, **3D GLB Generator**, **About**."
    )
